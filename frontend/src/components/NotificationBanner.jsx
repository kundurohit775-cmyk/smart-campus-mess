...
export function NotificationBanner({ readyOrders = [], onTrackOrder }) {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-4 space-y-3">
        ...
        <div className="card p-4 sm:p-5 border-status-success bg-gradient-to-br from-white via-white to-emerald-50/30 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 relative overflow-hidden animate-slide-up">
          ...
          {onTrackOrder && (
            <button
              ...
              className="btn-primary py-2 px-4 text-xs self-stretch sm:self-auto bg-gradient-to-r from-[#16A34A] to-[#10B981]"
            >
      ...
      {isLow && (
        <div className="card p-4 sm:p-5 border-amber-300 bg-gradient-to-br from-white via-white to-amber-50/30 flex items-center justify-between gap-3 relative overflow-hidden">
          <div className="flex items-center gap-3.5">
            <div className="w-10 h-10 rounded-xl bg-amber-50 border border-amber-100 text-[#D97706] flex items-center justify-center shrink-0 shadow-level-1">
